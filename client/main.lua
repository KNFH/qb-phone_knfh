...
RegisterNetEvent('qb-phone_new:client:toclientcallcenter')
AddEventHandler('qb-phone_new:client:toclientcallcenter', function()
    TriggerServerEvent('qb-phone_new:server:emergencylineadd')
end)

RegisterNUICallback('GetCurrentEmergency', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-phone_new:server:GetCurrentEmergency', function(Emergencya)
        cb(Emergencya)
    end)
end)

RegisterNUICallback('GetCurrentTaxi', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-phone_new:server:GetCurrentTaxi', function(taxi)
        cb(taxi)
    end)
end)

RegisterNUICallback('GetCurrentTow', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-phone_new:server:GetCurrentTow', function(tow)
        cb(tow)
    end)
end)

RegisterNUICallback('GetCurrentMech', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-phone_new:server:GetCurrentMech', function(mech)
        cb(mech)
    end)
end)
